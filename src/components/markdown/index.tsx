...
export default function Markdown({ children, ...props }: { children: string }) {
    return (
        <ReactMarkdown
            {...props}
            ...
            components={{
                ...
                code: ({ ...props }) => (
                    <code
                        {...props}
                        className="block bg-secondary rounded p-4 font-mono text-sm overflow-x-auto mb-4"
                    />
                ),
                ...
                th: ({ ...props }) => (
                    <th {...props} className="px-4 py-2 border border-gray-300 font-bold text-left" />
                ),
